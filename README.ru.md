...
Плагин VitePress, добавляющий поддержку различных типов диаграмм с использованием сервиса Kroki. Плагин автоматически преобразует блоки кода диаграмм в SVG-изображения, кэширует их локально и обеспечивает чистое, настраиваемое отображение с опциональными подписями.
...
graph TD
    ...
    B -->|Нет| D[Отмена]
```
<!-- diagram-caption: Пример блок-схемы -->
````
